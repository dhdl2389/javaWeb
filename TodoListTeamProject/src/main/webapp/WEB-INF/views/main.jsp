								...
								.each(
										...
										function() {
											...
											output += '</label><div class="wrapButton"><button onclick="selectContents('
													...
													+ '<label for="' + this.code + '" class="star"></label>'
											output += '</div></div>';
											output += '</span>';
										});
						document.getElementById('disp').innerHTML = output;
